...
public class MethodNotAllowedBuilder {
	...
	public static class NotAllowed {
		...
		private String build(String resource) {
			return ("<D:error xmlns:cosmo=\"http://osafoundation.org/cosmo/DAV\" xmlns:D=\"DAV:\">\n" +
					"  <cosmo:method-not-allowed>" + method + " not allowed for " + resource
					+ "</cosmo:method-not-allowed>\n" +
					"</D:error>");
		}
	}
}
