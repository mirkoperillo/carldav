...
class ICalendarUtilsTest {
	...
	void testPinFloatingTime() throws Exception {
		...
		assertEquals("20070101T000000",
				ICalendarUtils.pinFloatingTime(new DateTime("20070101T000000"), tz1).toString());
		...
		assertTrue(ICalendarUtils.pinFloatingTime(new Date("20070101"), tz1)
				.before(ICalendarUtils.pinFloatingTime(new Date("20070101"), tz2)));
		assertTrue(ICalendarUtils.pinFloatingTime(new DateTime("20070101T000000"), tz1)
				.before(ICalendarUtils.pinFloatingTime(new DateTime("20070101T000000"), tz2)));
	}
