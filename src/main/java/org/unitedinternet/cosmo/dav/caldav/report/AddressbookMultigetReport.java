...
public class AddressbookMultigetReport extends MultigetReport {
	...
	public static final ReportType REPORT_TYPE_CARDDAV_MULTIGET = ReportType.register(
			new QName(NS_CARDDAV, ELEMENT_CARDDAV_ADDRESSBOOK_MULTIGET, PRE_CARD), AddressbookMultigetReport.class);
