...
public interface WebDavResource {
	...
	/**
	 * String constant representing the WebDAV 1 compliance class as well as the
	 * Cosmo extended classes.
	 */
	...
	/**
	 * Return the time of the last modification or -1 if the modification time could
	 * not be retrieved.
	 *
	...
	/**
	 * Returns all webdav properties present on this resource that will be return
	 * upon a {@link DavConstants#PROPFIND_ALL_PROP} request. The implementation may
	 * in addition expose other (protected or calculated) properties which should be
	 * marked accordingly (see also {@link WebDavProperty#isInvisibleInAllprop()}.
	 *
	 * @return a {@link DavPropertySet} containing at least all properties of this
	 *         resource that are exposed in 'allprop' PROPFIND request.
	 */
	...
	/**
	 * Returns an array of all {@link DavPropertyName property names} available on
	 * this resource.
	 *
