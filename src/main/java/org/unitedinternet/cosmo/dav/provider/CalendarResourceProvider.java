...
public class CalendarResourceProvider extends BaseProvider {
	...
	public void put(HttpServletRequest request, HttpServletResponse response, WebDavResource content)
		...
		// do content.getCollection() check only for normal auth only, ticket auth is on
		// the item only, not its parent.
	...
	protected WebDavResource createCalendarResource(DavResourceLocator locator, Calendar calendar)
