...
public class StandardRequestHandler extends AbstractController implements ServerConstants {
	...
	public StandardRequestHandler(DavResourceLocatorFactory locatorFactory, DavResourceFactory resourceFactory,
			ExceptionResolverHandler exceptionResolverHandler) {
	...
	protected ModelAndView handleRequestInternal(final HttpServletRequest request, final HttpServletResponse response) {
		try {
			...
			// logs don't get too polluted with errors. For example,
			// OptimisticLockingFailureException
			// is expected and should be handled by the retry logic that is one layer above.
			// Although not ideal, for now simply check for this type and log at a different
			// level.
	...
	protected void preconditions(HttpServletRequest request, HttpServletResponse response, WebDavResource resource)
	...
	protected void process(HttpServletRequest request, HttpServletResponse response, WebDavResource resource)
	...
	private void ifMatch(HttpServletRequest request, HttpServletResponse response, WebDavResource resource)
			throws CosmoDavException {
	...
	private void ifNoneMatch(HttpServletRequest request, HttpServletResponse response, WebDavResource resource)
			throws CosmoDavException {
