...
public final class CarldavConstants {
	...
	public static final MediaType TEXT_CALENDAR = new MediaType("text", ELEMENT_CALDAV_CALENDAR,
	...
	public static final DavPropertyName PROPERTY_ACL_CURRENT_USER_PRIVILEGE_SET = create(
			caldav("current-user-privilege-set"));
	...
	public static final DavPropertyName SUPPORTED_CALENDAR_COMPONENT_SET = create(
