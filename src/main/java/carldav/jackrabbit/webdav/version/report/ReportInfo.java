...
public class ReportInfo implements XmlSerializable {
	 ...
	 *
	 * @param reportElement
	 * @param depth         Depth value as retrieved from the
	 ...
	 * collection itself and to all members of the collection that satisfy the depth
	 * value.
	 *
	 * @return depth
	 */
	...
	public boolean containsContentElement(QName namespace) {
		...
		for (Element elem : content) {
			boolean sameNamespace = (namespace == null) ? elem.getNamespaceURI() == null
					: namespace.getNamespaceURI().equals(elem.getNamespaceURI());
	...
	/**
	 * Returns a list containing all child Xml elements of this info that have the
	 * specified name/namespace. If this info contains no such element, an empty
	 * list is returned.
	 *
	 * @param namespace
	 * @return List contain all child elements with the given name/namespace or an
	 *         empty list.
	 */
	 ...
	 *
	 * @return {@link DavPropertyNameSet} providing the property names present in an
	 *         eventual {@link DavConstants#XML_PROP DAV:prop} child element or an
	 *         empty set.
	 */
