...
public class DavPropertyNameSet extends PropContainer {
	 ...
	 *                                  <code>null</code> or is not a DAV:prop
	 *                                  element.
	 */
	...
	/**
	 * Adds the specified {@link DavPropertyName} object to this set if it is not
	 * already present.
	 *
	...
	/**
	 * @param contentEntry NOTE that an instance of <code>DavPropertyName</code> in
	 *                     order to successfully add the given entry.
